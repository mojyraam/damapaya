...
workbenchController.save = (req, res, err) => {
    ...
    let data = [
        ...
        req.body.specifications1,
        req.body.specifications2,
        req.body.specifications3,
        req.body.specifications4,
        req.body.specifications5,
        req.body.specifications6,
        req.body.specifications7,
        req.body.specifications8,
        req.body.specifications9,
        req.body.specifications10,
        req.body.specifications11,
        req.body.specifications12,
        req.body.specifications13,
        req.body.specifications14,
        req.body.specifications15,
